...
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_images_mainmenu_exit_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:keep @:image("assets/images/mainmenu/options.png") @:noCompletion #if display private #end class __ASSET__assets_images_mainmenu_options_png extends lime.graphics.Image {}
@:keep @:image("assets/images/mainmenu/exit.png") @:noCompletion #if display private #end class __ASSET__assets_images_mainmenu_exit_png extends lime.graphics.Image {}
